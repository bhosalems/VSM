#!/bin/bash
export OPENAI_LOGDIR=/home/csgrad/mbhosale/phd/ddpm_hallucination/halmin/DDPM-IP/log/Cat_Dog_UC_Variance_OFF_V4
...
mpirun -n 2 -env PYTHONPATH "$PYTHONPATH" python scripts/image_train.py --data_dir /home/csgrad/mbhosale/phd/ddpm_hallucination/halmin/latent-diffusion/datasets/train/ \
	...
	--num_res_blocks 3 --attention_resolutions 32,16,8 --resblock_updown True --use_new_attention_order \
	True --learn_sigma False --dropout 0.1 --diffusion_steps 1000 --noise_schedule cosine --use_scale_shift_norm True \
	--rescale_learned_sigmas False --schedule_sampler loss-second-moment --lr 1e-5 --batch_size 2 --rho 0.0 \